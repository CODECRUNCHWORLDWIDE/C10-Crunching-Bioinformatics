...
If you scored under 7, re-read Lecture 1 §2-4 (genotype model + bcftools pipeline) and Lecture 2 §1-5 (GATK, hard filters, VEP). If you scored 9 or 10, you are ready to start the [homework](./06-homework.md).
