...
- [Lecture 1 — From BAM to VCF with bcftools](../02-lecture-notes/01-from-bam-to-vcf-bcftools.md)
- [Lecture 2 — GATK Best Practices and hard filters](../02-lecture-notes/02-gatk-best-practices-and-hard-filters.md)
- [Challenge 1 — Compare bcftools and GATK on the same BAM](../04-challenges/challenge-01-compare-callers.md)
- [resources.md](../01-resources.md) — full week resource list.
