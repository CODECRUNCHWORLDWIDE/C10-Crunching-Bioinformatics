...
If you scored under 7, re-read Lecture 1 §2-4 (RNA-seq biology + fastp) and Lecture 2 §2-3 (k-mer compatibility + EM). If you scored 9 or 10, you are ready to start the [homework](./06-homework.md).
