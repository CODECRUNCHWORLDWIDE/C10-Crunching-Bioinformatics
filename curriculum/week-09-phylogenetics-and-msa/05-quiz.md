...
If you scored under 7, re-read Lecture 1 §3 (MAFFT and reproducibility), Lecture 2 §3-§4 (JC and K2P), and Lecture 2 §9 (bootstrap interpretation). If you scored 9 or 10, you are ready to start the [homework](./06-homework.md).
