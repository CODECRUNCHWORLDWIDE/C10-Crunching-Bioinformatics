...
If you scored under 7, re-read Lecture 1 §2 (the three axes) and Lecture 3 §2-3 (the ACMG criteria and the mechanically computable subset). If you scored 9 or 10, you are ready to start the [homework](./06-homework.md).
