...
- [Lecture 1 — From FASTQ to BAM](../02-lecture-notes/01-from-fastq-to-bam.md)
- [Lecture 2 — SAM/BAM format and samtools](../02-lecture-notes/02-sam-bam-format-and-samtools.md)
- [Challenge 1 — Detect duplicates by hand](../04-challenges/challenge-01-detect-duplicates.md)
