...
| [resources.md](./01-resources.md) | Curated Biopython tutorial chapters, FASTQ specs, FastQC docs, 1000 Genomes data portal |
| [lecture-notes/01-fasta-the-line-format.md](./02-lecture-notes/01-fasta-the-line-format.md) | FASTA in depth, Biopython `SeqIO`, `SeqRecord`, write-out |
| [lecture-notes/02-fastq-and-quality-scores.md](./02-lecture-notes/02-fastq-and-quality-scores.md) | FASTQ format, Phred scores, encoding zoo, FastQC |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of short drills |
| [exercises/exercise-01-parse-fasta-biopython.py](./03-exercises/exercise-01-parse-fasta-biopython.py) | Re-parse last week's FASTA with Biopython |
| [exercises/exercise-02-fastq-quality-plot.py](./03-exercises/exercise-02-fastq-quality-plot.py) | Plot per-base quality across a FASTQ file |
| [exercises/exercise-03-filter-by-quality.py](./03-exercises/exercise-03-filter-by-quality.py) | Filter reads on mean quality and length |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of weekly challenges |
| [challenges/challenge-01-streaming-large-fasta.md](./04-challenges/challenge-01-streaming-large-fasta.md) | Stream a multi-GB FASTA without loading it into RAM |
| [quiz.md](./05-quiz.md) | 10 multiple-choice questions, format and quality |
| [homework.md](./06-homework.md) | Six practice problems for the week |
| [mini-project/README.md](./07-mini-project/00-overview.md) | QC report on a 1000 Genomes chr22 FASTQ subset |
