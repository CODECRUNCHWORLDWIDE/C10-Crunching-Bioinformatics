...
If you scored under 7, re-read Lecture 1 for the algorithm and statistics questions and Lecture 2 for the BLAST family and Biopython API questions. If you scored 9 or 10, you are ready to start the [homework](./06-homework.md).
