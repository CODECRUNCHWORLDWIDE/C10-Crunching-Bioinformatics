...
- [Lecture 1 — How BLAST actually works](../02-lecture-notes/01-how-blast-actually-works.md)
- [Lecture 2 — Running BLAST locally and via NCBI](../02-lecture-notes/02-running-blast-locally-and-via-ncbi.md)
- [Challenge 1 — Taxonomy classifier (the rehearsal at N=8)](../04-challenges/challenge-01-taxonomy-classifier.md)
