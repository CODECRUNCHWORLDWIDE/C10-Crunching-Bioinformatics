...
If you scored under 7, re-read Lecture 1 for the algorithm questions and Lecture 2 for the substitution-matrix and gap-penalty questions. If you scored 9 or 10, you are ready to start the [homework](./06-homework.md).
