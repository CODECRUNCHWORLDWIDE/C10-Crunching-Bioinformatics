...
- **Use the field's voice** — "is associated with," "is a region of," not "is what makes you tall." See the voice rules in [Lecture 2 §7](../02-lecture-notes/02-data-ethics-and-public-data-sources.md).
