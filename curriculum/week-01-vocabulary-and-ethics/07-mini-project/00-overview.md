...
- [ ] `week-01/data-inventory.md`:
  - Contains the 9-column table specified in [Exercise 3](../03-exercises/exercise-03-data-inventory.md).
...
- [resources.md](../01-resources.md) — every source you might cite.
