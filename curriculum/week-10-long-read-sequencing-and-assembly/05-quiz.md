...
If you scored under 7, re-read Lecture 1 §2-§4 (the two platforms), Lecture 2 §3-§6 (the three assemblers), and Lecture 3 §3 and §10 (Medaka, failure modes). If you scored 9 or 10, you are ready to start the [homework](./06-homework.md).
